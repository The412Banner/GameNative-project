package com.antutu.ABenchMark.service.gog

import android.content.Context
import com.antutu.ABenchMark.data.DownloadInfo
import com.antutu.ABenchMark.service.gog.api.DepotFile
import com.antutu.ABenchMark.service.gog.api.FileChunk
import com.antutu.ABenchMark.service.gog.api.GOGApiClient
import com.antutu.ABenchMark.service.gog.api.GOGManifestMeta
import com.antutu.ABenchMark.service.gog.api.GOGManifestParser
import com.antutu.ABenchMark.service.gog.api.V1DepotFile
...
class GOGDownloadManager @Inject constructor(
    ...
    suspend fun downloadGame(
        ...
        try {
            ...
            com.antutu.ABenchMark.PluviaApp.events.emitJava(
                com.antutu.ABenchMark.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, true),
            )
            ...
            com.antutu.ABenchMark.PluviaApp.events.emitJava(
                com.antutu.ABenchMark.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, false),
            )
    ...
    private suspend fun finalizeInstallSuccess(gameId: String, installPath: File, downloadInfo: DownloadInfo) {
        ...
        com.antutu.ABenchMark.PluviaApp.events.emitJava(
            com.antutu.ABenchMark.events.AndroidEvent.LibraryInstallStatusChanged(gameId.toIntOrNull() ?: 0),
        )
    }
    ...
    private suspend fun downloadGameGen1(
        ...
        installPath: File,
        downloadInfo: DownloadInfo,
        gameManifest: com.antutu.ABenchMark.service.gog.api.GOGManifestMeta,
        selectedBuild: com.antutu.ABenchMark.service.gog.api.GOGBuild,
        language: String,
        withDlcs: Boolean,
        supportDir: File?,
    ): Result<Unit> = withContext(Dispatchers.IO) {
