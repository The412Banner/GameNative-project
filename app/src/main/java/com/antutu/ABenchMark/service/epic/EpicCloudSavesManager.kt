package com.antutu.ABenchMark.service.epic

import android.content.Context
import com.antutu.ABenchMark.data.EpicGame
import com.antutu.ABenchMark.service.epic.manifest.EpicManifest
import com.antutu.ABenchMark.utils.Net
import java.io.File
...
object EpicCloudSavesManager {
    ...
    private suspend fun determineSyncAction(
        context: Context,
        accountId: String,
        game: com.antutu.ABenchMark.data.EpicGame,
    ...
    private fun packageSaveFiles(
        ...
        try {
            ...
            val chunks = mutableListOf<com.antutu.ABenchMark.service.epic.manifest.ChunkInfo>()
            val fileManifests = mutableListOf<com.antutu.ABenchMark.service.epic.manifest.FileManifest>()
            ...
            files.forEach { file ->
                try {
                    ...
                    val fileManifest = com.antutu.ABenchMark.service.epic.manifest.FileManifest()
                    ...
                    while (fileOffset < fileData.size) {
                        ...
                        val chunkPart = com.antutu.ABenchMark.service.epic.manifest.ChunkPart(
    ...
    private fun finalizeChunk(
    ...
    ): com.antutu.ABenchMark.service.epic.manifest.ChunkInfo {
        ...
        val chunkInfo = com.antutu.ABenchMark.service.epic.manifest.ChunkInfo()
        chunkInfo.guid = guid
    ...
    private fun createManifest(
        game: EpicGame,
        accountId: String,
        chunks: List<com.antutu.ABenchMark.service.epic.manifest.ChunkInfo>,
        fileManifests: List<com.antutu.ABenchMark.service.epic.manifest.FileManifest>,
    ): com.antutu.ABenchMark.service.epic.manifest.EpicManifest {
        val manifest = com.antutu.ABenchMark.service.epic.manifest.BinaryManifest()

        // Meta
        manifest.meta = com.antutu.ABenchMark.service.epic.manifest.ManifestMeta()
        ...
        // Custom fields
        manifest.customFields = com.antutu.ABenchMark.service.epic.manifest.CustomFields()
        manifest.customFields!!["CloudSaveFolder"] = game.saveFolder

        // Chunks
        manifest.chunkDataList = com.antutu.ABenchMark.service.epic.manifest.ChunkDataList()
        manifest.chunkDataList!!.elements.addAll(chunks)

        // Files
        manifest.fileManifestList = com.antutu.ABenchMark.service.epic.manifest.FileManifestList()
    ...
    private fun resolveSaveDirectory(context: Context, game: EpicGame, accountId: String): File? {
        ...
        val container = com.antutu.ABenchMark.utils.ContainerUtils.getOrCreateContainer(context, appId)
