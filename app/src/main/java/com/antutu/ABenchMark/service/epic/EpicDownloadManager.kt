...
class EpicDownloadManager @Inject constructor(
    ...
    suspend fun downloadGame(
        ...
        try {
            ...
            com.antutu.ABenchMark.PluviaApp.events.emitJava(
                com.antutu.ABenchMark.events.AndroidEvent.DownloadStatusChanged(gameId, true),
            )
            ...
            com.antutu.ABenchMark.PluviaApp.events.emitJava(
                com.antutu.ABenchMark.events.AndroidEvent.LibraryInstallStatusChanged(gameId),
            )
            ...
            com.antutu.ABenchMark.PluviaApp.events.emitJava(
                com.antutu.ABenchMark.events.AndroidEvent.DownloadStatusChanged(gameId, false),
            )
        }
    }
    ...
    private suspend fun downloadChunkWithRetry(
        chunk: com.antutu.ABenchMark.service.epic.manifest.ChunkInfo,
        chunkCacheDir: File,
        chunkDir: String,
    ...
    private suspend fun assembleFile(
        fileManifest: com.antutu.ABenchMark.service.epic.manifest.FileManifest,
        chunkCacheDir: File,
        installDir: File,
    ): Result<File> = withContext(Dispatchers.IO) {
        try {
