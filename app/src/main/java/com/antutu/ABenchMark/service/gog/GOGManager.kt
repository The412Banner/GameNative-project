...
import com.antutu.ABenchMark.data.GOGCloudSavesLocation
import com.antutu.ABenchMark.data.GOGCloudSavesLocationTemplate
...
import com.antutu.ABenchMark.utils.FileUtils
...
class GOGManager @Inject constructor(
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                com.antutu.ABenchMark.PluviaApp.events.emitJava(
                    com.antutu.ABenchMark.events.AndroidEvent.LibraryInstallStatusChanged(libraryItem.gameId),
                )
    ...
    fun runScriptInterpreterIfNeeded(
        ...
        for (i in 0 until productsArray.length()) {
            ...
            try {
                PluviaApp.events.emit(com.antutu.ABenchMark.events.AndroidEvent.SetBootingSplashText("Running GOG script interpreter..."))
