...
import com.antutu.ABenchMark.data.EpicCredentials
...
import com.antutu.ABenchMark.data.EpicGameToken
...
import com.antutu.ABenchMark.service.NotificationHelper
...
class EpicService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_SYNC_LIBRARY = "com.antutu.ABenchMark.EPIC_SYNC_LIBRARY"
        private const val ACTION_MANUAL_SYNC = "com.antutu.ABenchMark.EPIC_MANUAL_SYNC"
        ...
        suspend fun deleteGame(context: Context, appId: Int): Result<Unit> {
            ...
            return try {
                ...
                com.antutu.ABenchMark.PluviaApp.events.emitJava(
                    com.antutu.ABenchMark.events.AndroidEvent.LibraryInstallStatusChanged(appId)
                )
