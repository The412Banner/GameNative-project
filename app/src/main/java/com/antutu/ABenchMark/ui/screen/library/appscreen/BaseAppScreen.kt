...
import com.antutu.ABenchMark.utils.GameMetadataManager
import com.antutu.ABenchMark.utils.SteamGridDB
import com.antutu.ABenchMark.utils.createPinnedShortcut
...
abstract class BaseAppScreen {
    ...
    companion object {
        private val installDialogStates = mutableStateMapOf<String, com.antutu.ABenchMark.ui.component.dialog.state.MessageDialogState>()

        fun showInstallDialog(appId: String, state: com.antutu.ABenchMark.ui.component.dialog.state.MessageDialogState) {
        ...
        fun getInstallDialogState(appId: String): com.antutu.ABenchMark.ui.component.dialog.state.MessageDialogState? {
    ...
    fun Content(
        ...
        val downloadInfo = when (libraryItem.gameSource) {
            com.antutu.ABenchMark.data.GameSource.STEAM -> com.antutu.ABenchMark.service.SteamService.getAppDownloadInfo(displayInfo.gameId)
            com.antutu.ABenchMark.data.GameSource.EPIC -> com.antutu.ABenchMark.service.epic.EpicService.getDownloadInfo(displayInfo.gameId)
            com.antutu.ABenchMark.data.GameSource.GOG -> com.antutu.ABenchMark.service.gog.GOGService.getDownloadInfo(displayInfo.gameId.toString())
            com.antutu.ABenchMark.data.GameSource.CUSTOM_GAME -> null // Custom games don't support downloads yet
            com.antutu.ABenchMark.data.GameSource.AMAZON -> com.antutu.ABenchMark.service.amazon.AmazonService.getDownloadInfoByAppId(libraryItem.gameId)
        }
        ...
        com.antutu.ABenchMark.ui.screen.library.AppScreenContent(
