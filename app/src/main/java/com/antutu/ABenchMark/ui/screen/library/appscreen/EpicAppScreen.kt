package com.antutu.ABenchMark.ui.screen.library.appscreen
...
import com.antutu.ABenchMark.service.epic.EpicCloudSavesManager
import com.antutu.ABenchMark.service.epic.EpicConstants
import com.antutu.ABenchMark.service.epic.EpicService
import com.antutu.ABenchMark.ui.data.AppMenuOption
import com.antutu.ABenchMark.ui.data.GameDisplayInfo
import com.antutu.ABenchMark.ui.enums.AppOptionMenuType
import com.antutu.ABenchMark.enums.Marker
import com.antutu.ABenchMark.utils.ContainerUtils
import com.antutu.ABenchMark.utils.ContainerUtils.extractGameIdFromContainerId
import com.antutu.ABenchMark.utils.MarkerUtils
...
import com.antutu.ABenchMark.ui.util.SnackbarManager
...
class EpicAppScreen : BaseAppScreen() {
    ...
    companion object {
        ...
        private val gameManagerDialogStates = mutableStateMapOf<Int, com.antutu.ABenchMark.ui.component.dialog.state.GameManagerDialogState>()

        fun showGameManagerDialog(gameId: Int, state: com.antutu.ABenchMark.ui.component.dialog.state.GameManagerDialogState) {
        ...
        fun getGameManagerDialogState(gameId: Int): com.antutu.ABenchMark.ui.component.dialog.state.GameManagerDialogState? {
    ...
    override fun getGameDisplayInfo(
        ...
        DisposableEffect(gameId) {
            val installListener: (com.antutu.ABenchMark.events.AndroidEvent.LibraryInstallStatusChanged) -> Unit = { event ->
            ...
            com.antutu.ABenchMark.PluviaApp.events.on<com.antutu.ABenchMark.events.AndroidEvent.LibraryInstallStatusChanged, Unit>(installListener)
            onDispose {
                com.antutu.ABenchMark.PluviaApp.events.off<com.antutu.ABenchMark.events.AndroidEvent.LibraryInstallStatusChanged, Unit>(installListener)
            }
        }
    ...
    override fun onDownloadInstallClick(context: Context, libraryItem: LibraryItem, onClickPlay: (Boolean) -> Unit) {
        ...
        if (isDownloading) {
            ...
            showInstallDialog(
                libraryItem.appId,
                com.antutu.ABenchMark.ui.component.dialog.state.MessageDialogState(
                    visible = true,
                    type = com.antutu.ABenchMark.ui.enums.DialogType.CANCEL_APP_DOWNLOAD,
            ...
            showGameManagerDialog(
                gameId,
                com.antutu.ABenchMark.ui.component.dialog.state.GameManagerDialogState(visible = true)
            )
        }
    }
    ...
    override fun loadContainerData(context: Context, libraryItem: LibraryItem): ContainerData {
        ...
        val container = com.antutu.ABenchMark.utils.ContainerUtils.getOrCreateContainer(context, libraryItem.appId)
        val containerData = com.antutu.ABenchMark.utils.ContainerUtils.toContainerData(container)
    ...
    override fun saveContainerConfig(context: Context, libraryItem: LibraryItem, config: ContainerData) {
        ...
        com.antutu.ABenchMark.utils.ContainerUtils.applyToContainer(context, libraryItem.appId, config)
    ...
    override fun observeGameState(
        ...
        val downloadStatusListener: (com.antutu.ABenchMark.events.AndroidEvent.DownloadStatusChanged) -> Unit = { event ->
        ...
        com.antutu.ABenchMark.PluviaApp.events.on<com.antutu.ABenchMark.events.AndroidEvent.DownloadStatusChanged, Unit>(downloadStatusListener)
        disposables +=
            { com.antutu.ABenchMark.PluviaApp.events.off<com.antutu.ABenchMark.events.AndroidEvent.DownloadStatusChanged, Unit>(downloadStatusListener) }
    ...
    override fun AdditionalDialogs(
        ...
        var installDialogState by remember(appId) {
            mutableStateOf(BaseAppScreen.getInstallDialogState(appId) ?: com.antutu.ABenchMark.ui.component.dialog.state.MessageDialogState(false))
        }
        LaunchedEffect(appId) {
            snapshotFlow { BaseAppScreen.getInstallDialogState(appId) }
                .collect { state ->
                    installDialogState = state ?: com.antutu.ABenchMark.ui.component.dialog.state.MessageDialogState(false)
                }
        }

        // Game manager dialog state
        var gameManagerDialogState by remember(gameId) {
            mutableStateOf(getGameManagerDialogState(gameId) ?: com.antutu.ABenchMark.ui.component.dialog.state.GameManagerDialogState(false))
        }
        LaunchedEffect(gameId) {
            snapshotFlow { getGameManagerDialogState(gameId) }
                .collect { state ->
                    gameManagerDialogState = state ?: com.antutu.ABenchMark.ui.component.dialog.state.GameManagerDialogState(false)
                }
        }
        ...
        if (installDialogState.visible) {
            ...
            val onConfirmClick: (() -> Unit)? = when (installDialogState.type) {
                com.antutu.ABenchMark.ui.enums.DialogType.INSTALL_APP -> {
                    {
                        BaseAppScreen.hideInstallDialog(appId)
                        performDownload(scope, context, libraryItem, listOf(libraryItem.gameId)) {}
                    }
                }
                com.antutu.ABenchMark.ui.enums.DialogType.CANCEL_APP_DOWNLOAD -> {
                    {
                        ...
                        scope.launch {
                            ...
                            withContext(Dispatchers.Main) {
                                BaseAppScreen.hideInstallDialog(appId)
                                com.antutu.ABenchMark.PluviaApp.events.emit(com.antutu.ABenchMark.events.AndroidEvent.DownloadStatusChanged(gameId, false))
                                com.antutu.ABenchMark.PluviaApp.events.emit(com.antutu.ABenchMark.events.AndroidEvent.LibraryInstallStatusChanged(gameId))
                            }
                        }
                    }
                }
            ...
            com.antutu.ABenchMark.ui.component.dialog.MessageDialog(
        ...
        if (gameManagerDialogState.visible) {
            com.antutu.ABenchMark.ui.component.dialog.EpicGameManagerDialog(
                visible = true,
