...
import com.antutu.ABenchMark.Constants
...
import com.antutu.ABenchMark.enums.LoginResult
import com.antutu.ABenchMark.enums.PathType
import com.antutu.ABenchMark.enums.SaveLocation
import com.antutu.ABenchMark.enums.SyncResult
...
import com.antutu.ABenchMark.ui.component.ConnectionStatusBanner
import com.antutu.ABenchMark.service.epic.EpicService
import com.antutu.ABenchMark.service.gog.GOGService
import com.antutu.ABenchMark.ui.component.dialog.ContainerConfigDialog
import com.antutu.ABenchMark.ui.component.dialog.GameFeedbackDialog
import com.antutu.ABenchMark.ui.component.dialog.LoadingDialog
import com.antutu.ABenchMark.ui.component.dialog.MessageDialog
import com.antutu.ABenchMark.ui.component.dialog.state.GameFeedbackDialogState
import com.antutu.ABenchMark.ui.component.dialog.state.MessageDialogState
import com.antutu.ABenchMark.ui.components.BootingSplash
import com.antutu.ABenchMark.ui.enums.AppOptionMenuType
import com.antutu.ABenchMark.ui.enums.ConnectionState
import com.antutu.ABenchMark.ui.enums.DialogType
import com.antutu.ABenchMark.ui.enums.Orientation
import com.antutu.ABenchMark.ui.model.MainViewModel
import com.antutu.ABenchMark.ui.screen.HomeScreen
import com.antutu.ABenchMark.ui.screen.PluviaScreen
import com.antutu.ABenchMark.ui.screen.login.UserLoginScreen
import com.antutu.ABenchMark.ui.screen.settings.SettingsScreen
import com.antutu.ABenchMark.ui.screen.xserver.XServerScreen
import com.antutu.ABenchMark.ui.theme.PluviaTheme
import com.antutu.ABenchMark.ui.util.SnackbarManager
import com.antutu.ABenchMark.utils.BestConfigService
import com.antutu.ABenchMark.utils.ContainerUtils
import com.antutu.ABenchMark.utils.PlatformAuthUtils
import com.antutu.ABenchMark.utils.CustomGameScanner
import com.antutu.ABenchMark.utils.ManifestInstaller
import com.antutu.ABenchMark.utils.GameFeedbackUtils
import com.antutu.ABenchMark.utils.IntentLaunchManager
import com.antutu.ABenchMark.utils.UpdateChecker
import com.antutu.ABenchMark.utils.UpdateInfo
import com.antutu.ABenchMark.utils.UpdateInstaller
import com.antutu.ABenchMark.utils.LaunchDependencies
...
fun PluviaMain(
    ...
    LaunchedEffect(Unit) {
        lifecycleOwner.lifecycle.repeatOnLifecycle(Lifecycle.State.STARTED) {
            ...
            if (com.antutu.ABenchMark.service.gog.GOGService.hasStoredCredentials(context) &&
                !com.antutu.ABenchMark.service.gog.GOGService.isRunning
            ) {
                Timber.tag("GOG").d("[PluviaMain]: Starting GOGService for logged-in user")
                com.antutu.ABenchMark.service.gog.GOGService.start(context)
            } else {
                Timber.tag("GOG").d("GOG SERVICE Not going to start: ${com.antutu.ABenchMark.service.gog.GOGService.isRunning}")
            }

            // Start EpicService if user has Epic credentials
            if (com.antutu.ABenchMark.service.epic.EpicService.hasStoredCredentials(context) &&
                !com.antutu.ABenchMark.service.epic.EpicService.isRunning
            ) {
                Timber.d("[PluviaMain]: Starting EpicService for logged-in user")
                com.antutu.ABenchMark.service.epic.EpicService.start(context)
            }
...
fun preLaunchApp(
    ...
    CoroutineScope(Dispatchers.IO).launch {
        ...
        if (isGOGGame) {
            ...
            val syncSuccess = com.antutu.ABenchMark.service.gog.GOGService.syncCloudSaves(
                context = context,
                appId = appId,
            )
        ...
        if (isEpicGame) {
            ...
            val syncSuccess = com.antutu.ABenchMark.service.epic.EpicCloudSavesManager.syncCloudSaves(
                context = context,
                appId = gameId,
            )
