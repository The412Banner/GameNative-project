    ...
    override fun getGameDisplayInfo(
        ...
        LaunchedEffect(gameFolderPath) {
            gameFolderPath?.let { path ->
                ...
                val metadata = com.antutu.ABenchMark.utils.GameMetadataManager.read(folder)
                    ...
                    if (hasContainer) {
                        ...
                        if (!relExe.isNullOrEmpty()) {
                            ...
                            if (exeFile.exists()) {
                                ...
                                val extracted = com.antutu.ABenchMark.utils.ExeIconExtractor.tryExtractMainIcon(exeFile, outIco)
