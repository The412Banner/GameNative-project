...
import com.antutu.ABenchMark.service.gog.GOGConstants
...
import com.antutu.ABenchMark.utils.ContainerUtils.getContainer
    ...
    private fun showGOGInstallConfirmationDialog(context: Context, libraryItem: LibraryItem) {
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            try {
                ...
                // Calculate sizes
                val downloadSize = com.antutu.ABenchMark.utils.StorageUtils.formatBinarySize(game?.downloadSize ?: 0L)
                val availableSpace = com.antutu.ABenchMark.utils.StorageUtils.formatBinarySize(
                    com.antutu.ABenchMark.utils.StorageUtils.getAvailableSpace(com.antutu.ABenchMark.service.gog.GOGConstants.defaultGOGGamesPath)
                )
                ...
                val state = com.antutu.ABenchMark.ui.component.dialog.state.MessageDialogState(
                    visible = true,
                    type = com.antutu.ABenchMark.ui.enums.DialogType.INSTALL_APP,
