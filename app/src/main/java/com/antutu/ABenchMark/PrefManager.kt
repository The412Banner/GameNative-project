...
object PrefManager {
    ...
    var librarySortOption: com.antutu.ABenchMark.ui.enums.SortOption
        get() {
            ...
            return if (keyValue.isNotEmpty()) {
                com.antutu.ABenchMark.ui.enums.SortOption.fromKey(keyValue)
            } else {
                val ordinal = getPref(LIBRARY_SORT_LEGACY, com.antutu.ABenchMark.ui.enums.SortOption.INSTALLED_FIRST.ordinal)
                @Suppress("DEPRECATION")
                com.antutu.ABenchMark.ui.enums.SortOption.fromOrdinal(ordinal)
            }
        }
        set(value) {
