...
import com.ludashi.benchmark.data.GOGCloudSavesLocation
import com.ludashi.benchmark.data.GOGCloudSavesLocationTemplate
...
import com.ludashi.benchmark.data.PostSyncInfo
import com.ludashi.benchmark.data.SteamApp
import com.ludashi.benchmark.db.dao.GOGGameDao
import com.ludashi.benchmark.enums.AppType
import com.ludashi.benchmark.enums.ControllerSupport
...
class GOGManager @Inject constructor(
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                com.ludashi.benchmark.PluviaApp.events.emitJava(
                    com.ludashi.benchmark.events.AndroidEvent.LibraryInstallStatusChanged(libraryItem.gameId),
                )
    ...
    fun runScriptInterpreterIfNeeded(
        ...
        for (i in 0 until productsArray.length()) {
            ...
            try {
                PluviaApp.events.emit(com.ludashi.benchmark.events.AndroidEvent.SetBootingSplashText("Running GOG script interpreter..."))
