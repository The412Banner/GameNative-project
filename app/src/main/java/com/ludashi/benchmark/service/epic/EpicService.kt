...
import com.ludashi.benchmark.data.EpicCredentials
...
import com.ludashi.benchmark.data.EpicGameToken
...
import com.ludashi.benchmark.service.NotificationHelper
...
class EpicService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_SYNC_LIBRARY = "com.ludashi.benchmark.EPIC_SYNC_LIBRARY"
        private const val ACTION_MANUAL_SYNC = "com.ludashi.benchmark.EPIC_MANUAL_SYNC"
        ...
        suspend fun deleteGame(context: Context, appId: Int): Result<Unit> {
            ...
            return try {
                ...
                com.ludashi.benchmark.PluviaApp.events.emitJava(
                    com.ludashi.benchmark.events.AndroidEvent.LibraryInstallStatusChanged(appId)
                )
