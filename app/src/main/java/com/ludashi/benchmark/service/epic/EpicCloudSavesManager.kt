package com.ludashi.benchmark.service.epic

import android.content.Context
import com.ludashi.benchmark.data.EpicGame
import com.ludashi.benchmark.service.epic.manifest.EpicManifest
import com.ludashi.benchmark.utils.Net
import java.io.File
...
object EpicCloudSavesManager {
    ...
    private suspend fun determineSyncAction(
        context: Context,
        accountId: String,
        game: com.ludashi.benchmark.data.EpicGame,
    ...
    private fun packageSaveFiles(
        ...
        try {
            ...
            val chunks = mutableListOf<com.ludashi.benchmark.service.epic.manifest.ChunkInfo>()
            val fileManifests = mutableListOf<com.ludashi.benchmark.service.epic.manifest.FileManifest>()
            ...
            files.forEach { file ->
                try {
                    ...
                    val fileManifest = com.ludashi.benchmark.service.epic.manifest.FileManifest()
                    ...
                    while (fileOffset < fileData.size) {
                        ...
                        val chunkPart = com.ludashi.benchmark.service.epic.manifest.ChunkPart(
    ...
    private fun finalizeChunk(
    ...
    ): com.ludashi.benchmark.service.epic.manifest.ChunkInfo {
        ...
        val chunkInfo = com.ludashi.benchmark.service.epic.manifest.ChunkInfo()
        chunkInfo.guid = guid
    ...
    private fun createManifest(
        game: EpicGame,
        accountId: String,
        chunks: List<com.ludashi.benchmark.service.epic.manifest.ChunkInfo>,
        fileManifests: List<com.ludashi.benchmark.service.epic.manifest.FileManifest>,
    ): com.ludashi.benchmark.service.epic.manifest.EpicManifest {
        val manifest = com.ludashi.benchmark.service.epic.manifest.BinaryManifest()

        // Meta
        manifest.meta = com.ludashi.benchmark.service.epic.manifest.ManifestMeta()
        ...
        // Custom fields
        manifest.customFields = com.ludashi.benchmark.service.epic.manifest.CustomFields()
        manifest.customFields!!["CloudSaveFolder"] = game.saveFolder

        // Chunks
        manifest.chunkDataList = com.ludashi.benchmark.service.epic.manifest.ChunkDataList()
        manifest.chunkDataList!!.elements.addAll(chunks)

        // Files
        manifest.fileManifestList = com.ludashi.benchmark.service.epic.manifest.FileManifestList()
    ...
    private fun resolveSaveDirectory(context: Context, game: EpicGame, accountId: String): File? {
        ...
        val container = com.ludashi.benchmark.utils.ContainerUtils.getOrCreateContainer(context, appId)
