package com.ludashi.benchmark.service.gog

import android.content.Context
import com.ludashi.benchmark.data.DownloadInfo
import com.ludashi.benchmark.service.gog.api.DepotFile
import com.ludashi.benchmark.service.gog.api.FileChunk
import com.ludashi.benchmark.service.gog.api.GOGApiClient
import com.ludashi.benchmark.service.gog.api.GOGManifestMeta
import com.ludashi.benchmark.service.gog.api.GOGManifestParser
import com.ludashi.benchmark.service.gog.api.V1DepotFile
...
class GOGDownloadManager @Inject constructor(
    ...
    suspend fun downloadGame(
        ...
        try {
            ...
            com.ludashi.benchmark.PluviaApp.events.emitJava(
                com.ludashi.benchmark.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, true),
            )
            ...
            com.ludashi.benchmark.PluviaApp.events.emitJava(
                com.ludashi.benchmark.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, false),
            )
    ...
    private suspend fun finalizeInstallSuccess(gameId: String, installPath: File, downloadInfo: DownloadInfo) {
        ...
        com.ludashi.benchmark.PluviaApp.events.emitJava(
            com.ludashi.benchmark.events.AndroidEvent.LibraryInstallStatusChanged(gameId.toIntOrNull() ?: 0),
        )
    }
    ...
    private suspend fun downloadGameGen1(
        ...
        installPath: File,
        downloadInfo: DownloadInfo,
        gameManifest: com.ludashi.benchmark.service.gog.api.GOGManifestMeta,
        selectedBuild: com.ludashi.benchmark.service.gog.api.GOGBuild,
        language: String,
        withDlcs: Boolean,
        supportDir: File?,
    ): Result<Unit> = withContext(Dispatchers.IO) {
