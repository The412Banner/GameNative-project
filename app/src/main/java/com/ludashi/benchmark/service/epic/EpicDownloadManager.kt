...
class EpicDownloadManager @Inject constructor(
    ...
    suspend fun downloadGame(
        ...
        try {
            ...
            com.ludashi.benchmark.PluviaApp.events.emitJava(
                com.ludashi.benchmark.events.AndroidEvent.DownloadStatusChanged(gameId, true),
            )
            ...
            com.ludashi.benchmark.PluviaApp.events.emitJava(
                com.ludashi.benchmark.events.AndroidEvent.LibraryInstallStatusChanged(gameId),
            )
            ...
            com.ludashi.benchmark.PluviaApp.events.emitJava(
                com.ludashi.benchmark.events.AndroidEvent.DownloadStatusChanged(gameId, false),
            )
        }
    }
    ...
    private suspend fun downloadChunkWithRetry(
        chunk: com.ludashi.benchmark.service.epic.manifest.ChunkInfo,
        chunkCacheDir: File,
        chunkDir: String,
    ...
    private suspend fun assembleFile(
        fileManifest: com.ludashi.benchmark.service.epic.manifest.FileManifest,
        chunkCacheDir: File,
        installDir: File,
    ): Result<File> = withContext(Dispatchers.IO) {
        try {
