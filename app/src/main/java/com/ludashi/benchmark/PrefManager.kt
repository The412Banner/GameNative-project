...
object PrefManager {
    ...
    var librarySortOption: com.ludashi.benchmark.ui.enums.SortOption
        get() {
            ...
            return if (keyValue.isNotEmpty()) {
                com.ludashi.benchmark.ui.enums.SortOption.fromKey(keyValue)
            } else {
                val ordinal = getPref(LIBRARY_SORT_LEGACY, com.ludashi.benchmark.ui.enums.SortOption.INSTALLED_FIRST.ordinal)
                @Suppress("DEPRECATION")
                com.ludashi.benchmark.ui.enums.SortOption.fromOrdinal(ordinal)
            }
        }
        set(value) {
