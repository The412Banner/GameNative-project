package com.ludashi.benchmark.ui
...
import com.ludashi.benchmark.BuildConfig
import com.ludashi.benchmark.Constants
import com.ludashi.benchmark.MainActivity
...
import com.ludashi.benchmark.enums.SaveLocation
import com.ludashi.benchmark.enums.SyncResult
...
import com.ludashi.benchmark.ui.component.ConnectionStatusBanner
import com.ludashi.benchmark.service.epic.EpicService
import com.ludashi.benchmark.service.gog.GOGService
import com.ludashi.benchmark.ui.component.dialog.ContainerConfigDialog
import com.ludashi.benchmark.ui.component.dialog.GameFeedbackDialog
import com.ludashi.benchmark.ui.component.dialog.LoadingDialog
import com.ludashi.benchmark.ui.component.dialog.MessageDialog
import com.ludashi.benchmark.ui.component.dialog.state.GameFeedbackDialogState
import com.ludashi.benchmark.ui.component.dialog.state.MessageDialogState
import com.ludashi.benchmark.ui.components.BootingSplash
import com.ludashi.benchmark.ui.enums.AppOptionMenuType
import com.ludashi.benchmark.ui.enums.ConnectionState
import com.ludashi.benchmark.ui.enums.DialogType
import com.ludashi.benchmark.ui.enums.Orientation
import com.ludashi.benchmark.ui.model.MainViewModel
import com.ludashi.benchmark.ui.screen.HomeScreen
import com.ludashi.benchmark.ui.screen.PluviaScreen
import com.ludashi.benchmark.ui.screen.login.UserLoginScreen
import com.ludashi.benchmark.ui.screen.settings.SettingsScreen
import com.ludashi.benchmark.ui.screen.xserver.XServerScreen
import com.ludashi.benchmark.ui.theme.PluviaTheme
import com.ludashi.benchmark.ui.util.SnackbarManager
import com.ludashi.benchmark.utils.BestConfigService
import com.ludashi.benchmark.utils.ContainerUtils
import com.ludashi.benchmark.utils.PlatformAuthUtils
import com.ludashi.benchmark.utils.CustomGameScanner
import com.ludashi.benchmark.utils.ManifestInstaller
import com.ludashi.benchmark.utils.GameFeedbackUtils
import com.ludashi.benchmark.utils.IntentLaunchManager
import com.ludashi.benchmark.utils.UpdateChecker
import com.ludashi.benchmark.utils.UpdateInfo
import com.ludashi.benchmark.utils.UpdateInstaller
import com.ludashi.benchmark.utils.LaunchDependencies
...
fun PluviaMain(
    ...
    LaunchedEffect(Unit) {
        lifecycleOwner.lifecycle.repeatOnLifecycle(Lifecycle.State.STARTED) {
            ...
            if (com.ludashi.benchmark.service.gog.GOGService.hasStoredCredentials(context) &&
                !com.ludashi.benchmark.service.gog.GOGService.isRunning
            ) {
                Timber.tag("GOG").d("[PluviaMain]: Starting GOGService for logged-in user")
                com.ludashi.benchmark.service.gog.GOGService.start(context)
            } else {
                Timber.tag("GOG").d("GOG SERVICE Not going to start: ${com.ludashi.benchmark.service.gog.GOGService.isRunning}")
            }

            // Start EpicService if user has Epic credentials
            if (com.ludashi.benchmark.service.epic.EpicService.hasStoredCredentials(context) &&
                !com.ludashi.benchmark.service.epic.EpicService.isRunning
            ) {
                Timber.d("[PluviaMain]: Starting EpicService for logged-in user")
                com.ludashi.benchmark.service.epic.EpicService.start(context)
            }
...
fun preLaunchApp(
    ...
    CoroutineScope(Dispatchers.IO).launch {
        ...
        if (isGOGGame) {
            ...
            val syncSuccess = com.ludashi.benchmark.service.gog.GOGService.syncCloudSaves(
                context = context,
                appId = appId,
            )
        ...
        if (isEpicGame) {
            ...
            val syncSuccess = com.ludashi.benchmark.service.epic.EpicCloudSavesManager.syncCloudSaves(
                context = context,
                appId = gameId,
            )
