    ...
    override fun getGameDisplayInfo(
        ...
        LaunchedEffect(gameFolderPath) {
            gameFolderPath?.let { path ->
                ...
                val metadata = com.ludashi.benchmark.utils.GameMetadataManager.read(folder)
                    ...
                    if (hasContainer) {
                        ...
                        if (!relExe.isNullOrEmpty()) {
                            ...
                            if (exeFile.exists()) {
                                ...
                                val extracted = com.ludashi.benchmark.utils.ExeIconExtractor.tryExtractMainIcon(exeFile, outIco)
