...
import com.ludashi.benchmark.utils.GameMetadataManager
import com.ludashi.benchmark.utils.SteamGridDB
import com.ludashi.benchmark.utils.createPinnedShortcut
...
abstract class BaseAppScreen {
    ...
    companion object {
        private val installDialogStates = mutableStateMapOf<String, com.ludashi.benchmark.ui.component.dialog.state.MessageDialogState>()

        fun showInstallDialog(appId: String, state: com.ludashi.benchmark.ui.component.dialog.state.MessageDialogState) {
        ...
        fun getInstallDialogState(appId: String): com.ludashi.benchmark.ui.component.dialog.state.MessageDialogState? {
    ...
    fun Content(
        ...
        val downloadInfo = when (libraryItem.gameSource) {
            com.ludashi.benchmark.data.GameSource.STEAM -> com.ludashi.benchmark.service.SteamService.getAppDownloadInfo(displayInfo.gameId)
            com.ludashi.benchmark.data.GameSource.EPIC -> com.ludashi.benchmark.service.epic.EpicService.getDownloadInfo(displayInfo.gameId)
            com.ludashi.benchmark.data.GameSource.GOG -> com.ludashi.benchmark.service.gog.GOGService.getDownloadInfo(displayInfo.gameId.toString())
            com.ludashi.benchmark.data.GameSource.CUSTOM_GAME -> null // Custom games don't support downloads yet
            com.ludashi.benchmark.data.GameSource.AMAZON -> com.ludashi.benchmark.service.amazon.AmazonService.getDownloadInfoByAppId(libraryItem.gameId)
        }
        ...
        com.ludashi.benchmark.ui.screen.library.AppScreenContent(
