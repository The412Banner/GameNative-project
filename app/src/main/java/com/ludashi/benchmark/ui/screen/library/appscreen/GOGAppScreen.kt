...
import com.ludashi.benchmark.service.gog.GOGConstants
...
import com.ludashi.benchmark.utils.ContainerUtils.getContainer
    ...
    private fun showGOGInstallConfirmationDialog(context: Context, libraryItem: LibraryItem) {
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            try {
                ...
                // Calculate sizes
                val downloadSize = com.ludashi.benchmark.utils.StorageUtils.formatBinarySize(game?.downloadSize ?: 0L)
                val availableSpace = com.ludashi.benchmark.utils.StorageUtils.formatBinarySize(
                    com.ludashi.benchmark.utils.StorageUtils.getAvailableSpace(com.ludashi.benchmark.service.gog.GOGConstants.defaultGOGGamesPath)
                )
                ...
                val state = com.ludashi.benchmark.ui.component.dialog.state.MessageDialogState(
                    visible = true,
                    type = com.ludashi.benchmark.ui.enums.DialogType.INSTALL_APP,
