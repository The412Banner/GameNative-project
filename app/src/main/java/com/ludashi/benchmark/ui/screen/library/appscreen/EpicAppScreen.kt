package com.ludashi.benchmark.ui.screen.library.appscreen
...
import com.ludashi.benchmark.service.epic.EpicCloudSavesManager
import com.ludashi.benchmark.service.epic.EpicConstants
import com.ludashi.benchmark.service.epic.EpicService
import com.ludashi.benchmark.ui.data.AppMenuOption
import com.ludashi.benchmark.ui.data.GameDisplayInfo
import com.ludashi.benchmark.ui.enums.AppOptionMenuType
import com.ludashi.benchmark.enums.Marker
import com.ludashi.benchmark.utils.ContainerUtils
import com.ludashi.benchmark.utils.ContainerUtils.extractGameIdFromContainerId
import com.ludashi.benchmark.utils.MarkerUtils
...
import com.ludashi.benchmark.ui.util.SnackbarManager
...
class EpicAppScreen : BaseAppScreen() {
    ...
    companion object {
        ...
        private val gameManagerDialogStates = mutableStateMapOf<Int, com.ludashi.benchmark.ui.component.dialog.state.GameManagerDialogState>()

        fun showGameManagerDialog(gameId: Int, state: com.ludashi.benchmark.ui.component.dialog.state.GameManagerDialogState) {
        ...
        fun getGameManagerDialogState(gameId: Int): com.ludashi.benchmark.ui.component.dialog.state.GameManagerDialogState? {
    ...
    override fun getGameDisplayInfo(
        ...
        DisposableEffect(gameId) {
            val installListener: (com.ludashi.benchmark.events.AndroidEvent.LibraryInstallStatusChanged) -> Unit = { event ->
            ...
            com.ludashi.benchmark.PluviaApp.events.on<com.ludashi.benchmark.events.AndroidEvent.LibraryInstallStatusChanged, Unit>(installListener)
            onDispose {
                com.ludashi.benchmark.PluviaApp.events.off<com.ludashi.benchmark.events.AndroidEvent.LibraryInstallStatusChanged, Unit>(installListener)
            }
        }
    ...
    override fun onDownloadInstallClick(context: Context, libraryItem: LibraryItem, onClickPlay: (Boolean) -> Unit) {
        ...
        if (isDownloading) {
            ...
            showInstallDialog(
                libraryItem.appId,
                com.ludashi.benchmark.ui.component.dialog.state.MessageDialogState(
                    visible = true,
                    type = com.ludashi.benchmark.ui.enums.DialogType.CANCEL_APP_DOWNLOAD,
            ...
            showGameManagerDialog(
                gameId,
                com.ludashi.benchmark.ui.component.dialog.state.GameManagerDialogState(visible = true)
            )
        }
    }
    ...
    override fun loadContainerData(context: Context, libraryItem: LibraryItem): ContainerData {
        ...
        val container = com.ludashi.benchmark.utils.ContainerUtils.getOrCreateContainer(context, libraryItem.appId)
        val containerData = com.ludashi.benchmark.utils.ContainerUtils.toContainerData(container)
    ...
    override fun saveContainerConfig(context: Context, libraryItem: LibraryItem, config: ContainerData) {
        ...
        com.ludashi.benchmark.utils.ContainerUtils.applyToContainer(context, libraryItem.appId, config)
    ...
    override fun observeGameState(
        ...
        val downloadStatusListener: (com.ludashi.benchmark.events.AndroidEvent.DownloadStatusChanged) -> Unit = { event ->
        ...
        com.ludashi.benchmark.PluviaApp.events.on<com.ludashi.benchmark.events.AndroidEvent.DownloadStatusChanged, Unit>(downloadStatusListener)
        disposables +=
            { com.ludashi.benchmark.PluviaApp.events.off<com.ludashi.benchmark.events.AndroidEvent.DownloadStatusChanged, Unit>(downloadStatusListener) }
    ...
    override fun AdditionalDialogs(
        ...
        var installDialogState by remember(appId) {
            mutableStateOf(BaseAppScreen.getInstallDialogState(appId) ?: com.ludashi.benchmark.ui.component.dialog.state.MessageDialogState(false))
        }
        LaunchedEffect(appId) {
            snapshotFlow { BaseAppScreen.getInstallDialogState(appId) }
                .collect { state ->
                    installDialogState = state ?: com.ludashi.benchmark.ui.component.dialog.state.MessageDialogState(false)
                }
        }

        // Game manager dialog state
        var gameManagerDialogState by remember(gameId) {
            mutableStateOf(getGameManagerDialogState(gameId) ?: com.ludashi.benchmark.ui.component.dialog.state.GameManagerDialogState(false))
        }
        LaunchedEffect(gameId) {
            snapshotFlow { getGameManagerDialogState(gameId) }
                .collect { state ->
                    gameManagerDialogState = state ?: com.ludashi.benchmark.ui.component.dialog.state.GameManagerDialogState(false)
                }
        }
        ...
        if (installDialogState.visible) {
            ...
            val onConfirmClick: (() -> Unit)? = when (installDialogState.type) {
                com.ludashi.benchmark.ui.enums.DialogType.INSTALL_APP -> {
                    {
                        BaseAppScreen.hideInstallDialog(appId)
                        performDownload(scope, context, libraryItem, listOf(libraryItem.gameId)) {}
                    }
                }
                com.ludashi.benchmark.ui.enums.DialogType.CANCEL_APP_DOWNLOAD -> {
                    {
                        ...
                        scope.launch {
                            ...
                            withContext(Dispatchers.Main) {
                                BaseAppScreen.hideInstallDialog(appId)
                                com.ludashi.benchmark.PluviaApp.events.emit(com.ludashi.benchmark.events.AndroidEvent.DownloadStatusChanged(gameId, false))
                                com.ludashi.benchmark.PluviaApp.events.emit(com.ludashi.benchmark.events.AndroidEvent.LibraryInstallStatusChanged(gameId))
                            }
                        }
                    }
                }
            ...
            com.ludashi.benchmark.ui.component.dialog.MessageDialog(
        ...
        if (gameManagerDialogState.visible) {
            com.ludashi.benchmark.ui.component.dialog.EpicGameManagerDialog(
                visible = true,
