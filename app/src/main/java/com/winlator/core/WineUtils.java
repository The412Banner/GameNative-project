    ...
    public static void createDosdevicesSymlinks(Container container) {
        ...
        if (!currentDrives.contains("D:") || !currentDrives.contains("E:")) {
            ...
            if (!currentDrives.contains("E:")) {
                missingDrives += "E:/data/data/com.ludashi.benchmark/storage";
            }
        ...
        for (String[] drive : container.drivesIterator()) {
            ...
            if (!linkTarget.isDirectory() && path.endsWith("/com.ludashi.benchmark/storage")) {
                linkTarget.mkdirs();
        ...
        if (gameDirectoryPath != null) {
            // Extract game name from path like "/data/data/com.ludashi.benchmark/Steam/steamapps/common/GameName"
