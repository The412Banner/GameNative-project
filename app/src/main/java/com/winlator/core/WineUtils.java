    ...
    public static void createDosdevicesSymlinks(Container container) {
        ...
        if (!currentDrives.contains("D:") || !currentDrives.contains("E:")) {
            ...
            if (!currentDrives.contains("E:")) {
                missingDrives += "E:/data/data/com.antutu.ABenchMark/storage";
            }
        ...
        for (String[] drive : container.drivesIterator()) {
            ...
            if (!linkTarget.isDirectory() && path.endsWith("/com.antutu.ABenchMark/storage")) {
                linkTarget.mkdirs();
        ...
        if (gameDirectoryPath != null) {
            // Extract game name from path like "/data/data/com.antutu.ABenchMark/Steam/steamapps/common/GameName"
