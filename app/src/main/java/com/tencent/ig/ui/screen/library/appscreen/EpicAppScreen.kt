package com.tencent.ig.ui.screen.library.appscreen
...
import com.tencent.ig.service.epic.EpicCloudSavesManager
import com.tencent.ig.service.epic.EpicConstants
import com.tencent.ig.service.epic.EpicService
import com.tencent.ig.ui.data.AppMenuOption
import com.tencent.ig.ui.data.GameDisplayInfo
import com.tencent.ig.ui.enums.AppOptionMenuType
import com.tencent.ig.enums.Marker
import com.tencent.ig.utils.ContainerUtils
import com.tencent.ig.utils.ContainerUtils.extractGameIdFromContainerId
import com.tencent.ig.utils.MarkerUtils
...
import com.tencent.ig.ui.util.SnackbarManager
...
class EpicAppScreen : BaseAppScreen() {
    ...
    companion object {
        ...
        private val gameManagerDialogStates = mutableStateMapOf<Int, com.tencent.ig.ui.component.dialog.state.GameManagerDialogState>()

        fun showGameManagerDialog(gameId: Int, state: com.tencent.ig.ui.component.dialog.state.GameManagerDialogState) {
        ...
        fun getGameManagerDialogState(gameId: Int): com.tencent.ig.ui.component.dialog.state.GameManagerDialogState? {
    ...
    override fun getGameDisplayInfo(
        ...
        DisposableEffect(gameId) {
            val installListener: (com.tencent.ig.events.AndroidEvent.LibraryInstallStatusChanged) -> Unit = { event ->
            ...
            com.tencent.ig.PluviaApp.events.on<com.tencent.ig.events.AndroidEvent.LibraryInstallStatusChanged, Unit>(installListener)
            onDispose {
                com.tencent.ig.PluviaApp.events.off<com.tencent.ig.events.AndroidEvent.LibraryInstallStatusChanged, Unit>(installListener)
            }
        }
    ...
    override fun onDownloadInstallClick(context: Context, libraryItem: LibraryItem, onClickPlay: (Boolean) -> Unit) {
        ...
        if (isDownloading) {
            ...
            showInstallDialog(
                libraryItem.appId,
                com.tencent.ig.ui.component.dialog.state.MessageDialogState(
                    visible = true,
                    type = com.tencent.ig.ui.enums.DialogType.CANCEL_APP_DOWNLOAD,
            ...
            showGameManagerDialog(
                gameId,
                com.tencent.ig.ui.component.dialog.state.GameManagerDialogState(visible = true)
            )
        }
    }
    ...
    override fun loadContainerData(context: Context, libraryItem: LibraryItem): ContainerData {
        ...
        val container = com.tencent.ig.utils.ContainerUtils.getOrCreateContainer(context, libraryItem.appId)
        val containerData = com.tencent.ig.utils.ContainerUtils.toContainerData(container)
    ...
    override fun saveContainerConfig(context: Context, libraryItem: LibraryItem, config: ContainerData) {
        ...
        com.tencent.ig.utils.ContainerUtils.applyToContainer(context, libraryItem.appId, config)
    ...
    override fun observeGameState(
        ...
        val downloadStatusListener: (com.tencent.ig.events.AndroidEvent.DownloadStatusChanged) -> Unit = { event ->
        ...
        com.tencent.ig.PluviaApp.events.on<com.tencent.ig.events.AndroidEvent.DownloadStatusChanged, Unit>(downloadStatusListener)
        disposables +=
            { com.tencent.ig.PluviaApp.events.off<com.tencent.ig.events.AndroidEvent.DownloadStatusChanged, Unit>(downloadStatusListener) }
    ...
    override fun AdditionalDialogs(
        ...
        var installDialogState by remember(appId) {
            mutableStateOf(BaseAppScreen.getInstallDialogState(appId) ?: com.tencent.ig.ui.component.dialog.state.MessageDialogState(false))
        }
        LaunchedEffect(appId) {
            snapshotFlow { BaseAppScreen.getInstallDialogState(appId) }
                .collect { state ->
                    installDialogState = state ?: com.tencent.ig.ui.component.dialog.state.MessageDialogState(false)
                }
        }

        // Game manager dialog state
        var gameManagerDialogState by remember(gameId) {
            mutableStateOf(getGameManagerDialogState(gameId) ?: com.tencent.ig.ui.component.dialog.state.GameManagerDialogState(false))
        }
        LaunchedEffect(gameId) {
            snapshotFlow { getGameManagerDialogState(gameId) }
                .collect { state ->
                    gameManagerDialogState = state ?: com.tencent.ig.ui.component.dialog.state.GameManagerDialogState(false)
                }
        }
        ...
        if (installDialogState.visible) {
            ...
            val onConfirmClick: (() -> Unit)? = when (installDialogState.type) {
                com.tencent.ig.ui.enums.DialogType.INSTALL_APP -> {
                    {
                        BaseAppScreen.hideInstallDialog(appId)
                        performDownload(scope, context, libraryItem, listOf(libraryItem.gameId)) {}
                    }
                }
                com.tencent.ig.ui.enums.DialogType.CANCEL_APP_DOWNLOAD -> {
                    {
                        ...
                        scope.launch {
                            ...
                            withContext(Dispatchers.Main) {
                                BaseAppScreen.hideInstallDialog(appId)
                                com.tencent.ig.PluviaApp.events.emit(com.tencent.ig.events.AndroidEvent.DownloadStatusChanged(gameId, false))
                                com.tencent.ig.PluviaApp.events.emit(com.tencent.ig.events.AndroidEvent.LibraryInstallStatusChanged(gameId))
                            }
                        }
                    }
                }
            ...
            com.tencent.ig.ui.component.dialog.MessageDialog(
        ...
        if (gameManagerDialogState.visible) {
            com.tencent.ig.ui.component.dialog.EpicGameManagerDialog(
                visible = true,
