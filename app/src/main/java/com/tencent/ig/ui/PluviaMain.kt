...
import com.tencent.ig.Constants
import com.tencent.ig.MainActivity
import com.tencent.ig.PluviaApp
import com.tencent.ig.PrefManager
import com.tencent.ig.R
import com.tencent.ig.data.GameSource
import com.tencent.ig.enums.AppTheme
import com.tencent.ig.enums.LoginResult
import com.tencent.ig.enums.PathType
import com.tencent.ig.enums.SaveLocation
import com.tencent.ig.enums.SyncResult
import com.tencent.ig.events.AndroidEvent
import com.tencent.ig.service.SteamService
import com.tencent.ig.service.amazon.AmazonService
import com.posthog.PostHog
import com.tencent.ig.ui.component.ConnectionStatusBanner
import com.tencent.ig.service.epic.EpicService
import com.tencent.ig.service.gog.GOGService
import com.tencent.ig.ui.component.dialog.ContainerConfigDialog
import com.tencent.ig.ui.component.dialog.GameFeedbackDialog
import com.tencent.ig.ui.component.dialog.LoadingDialog
import com.tencent.ig.ui.component.dialog.MessageDialog
import com.tencent.ig.ui.component.dialog.state.GameFeedbackDialogState
import com.tencent.ig.ui.component.dialog.state.MessageDialogState
import com.tencent.ig.ui.components.BootingSplash
import com.tencent.ig.ui.enums.AppOptionMenuType
import com.tencent.ig.ui.enums.ConnectionState
import com.tencent.ig.ui.enums.DialogType
import com.tencent.ig.ui.enums.Orientation
import com.tencent.ig.ui.model.MainViewModel
import com.tencent.ig.ui.screen.HomeScreen
import com.tencent.ig.ui.screen.PluviaScreen
import com.tencent.ig.ui.screen.login.UserLoginScreen
import com.tencent.ig.ui.screen.settings.SettingsScreen
import com.tencent.ig.ui.screen.xserver.XServerScreen
import com.tencent.ig.ui.theme.PluviaTheme
import com.tencent.ig.ui.util.SnackbarManager
import com.tencent.ig.utils.BestConfigService
import com.tencent.ig.utils.ContainerUtils
import com.tencent.ig.utils.PlatformAuthUtils
import com.tencent.ig.utils.CustomGameScanner
import com.tencent.ig.utils.ManifestInstaller
import com.tencent.ig.utils.GameFeedbackUtils
import com.tencent.ig.utils.IntentLaunchManager
import com.tencent.ig.utils.UpdateChecker
import com.tencent.ig.utils.UpdateInfo
import com.tencent.ig.utils.UpdateInstaller
import com.tencent.ig.utils.LaunchDependencies
...
fun PluviaMain(
    ...
    LaunchedEffect(Unit) {
        lifecycleOwner.lifecycle.repeatOnLifecycle(Lifecycle.State.STARTED) {
            ...
            if (com.tencent.ig.service.gog.GOGService.hasStoredCredentials(context) &&
                !com.tencent.ig.service.gog.GOGService.isRunning
            ) {
                Timber.tag("GOG").d("[PluviaMain]: Starting GOGService for logged-in user")
                com.tencent.ig.service.gog.GOGService.start(context)
            } else {
                Timber.tag("GOG").d("GOG SERVICE Not going to start: ${com.tencent.ig.service.gog.GOGService.isRunning}")
            }

            // Start EpicService if user has Epic credentials
            if (com.tencent.ig.service.epic.EpicService.hasStoredCredentials(context) &&
                !com.tencent.ig.service.epic.EpicService.isRunning
            ) {
                Timber.d("[PluviaMain]: Starting EpicService for logged-in user")
                com.tencent.ig.service.epic.EpicService.start(context)
            }
...
fun preLaunchApp(
    ...
    CoroutineScope(Dispatchers.IO).launch {
        ...
        if (isGOGGame) {
            ...
            val syncSuccess = com.tencent.ig.service.gog.GOGService.syncCloudSaves(
                context = context,
                appId = appId,
            )
        ...
        if (isEpicGame) {
            ...
            val syncSuccess = com.tencent.ig.service.epic.EpicCloudSavesManager.syncCloudSaves(
                context = context,
                appId = gameId,
            )
