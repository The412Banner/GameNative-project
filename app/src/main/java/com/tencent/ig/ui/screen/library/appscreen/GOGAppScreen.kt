...
import com.tencent.ig.service.gog.GOGConstants
...
import com.tencent.ig.utils.ContainerUtils.getContainer
    ...
    private fun showGOGInstallConfirmationDialog(context: Context, libraryItem: LibraryItem) {
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            try {
                ...
                // Calculate sizes
                val downloadSize = com.tencent.ig.utils.StorageUtils.formatBinarySize(game?.downloadSize ?: 0L)
                val availableSpace = com.tencent.ig.utils.StorageUtils.formatBinarySize(
                    com.tencent.ig.utils.StorageUtils.getAvailableSpace(com.tencent.ig.service.gog.GOGConstants.defaultGOGGamesPath)
                )
                ...
                val state = com.tencent.ig.ui.component.dialog.state.MessageDialogState(
                    visible = true,
                    type = com.tencent.ig.ui.enums.DialogType.INSTALL_APP,
