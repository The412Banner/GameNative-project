...
import com.tencent.ig.utils.GameMetadataManager
import com.tencent.ig.utils.SteamGridDB
import com.tencent.ig.utils.createPinnedShortcut
...
abstract class BaseAppScreen {
    ...
    companion object {
        private val installDialogStates = mutableStateMapOf<String, com.tencent.ig.ui.component.dialog.state.MessageDialogState>()

        fun showInstallDialog(appId: String, state: com.tencent.ig.ui.component.dialog.state.MessageDialogState) {
        ...
        fun getInstallDialogState(appId: String): com.tencent.ig.ui.component.dialog.state.MessageDialogState? {
    ...
    fun Content(
        ...
        val downloadInfo = when (libraryItem.gameSource) {
            com.tencent.ig.data.GameSource.STEAM -> com.tencent.ig.service.SteamService.getAppDownloadInfo(displayInfo.gameId)
            com.tencent.ig.data.GameSource.EPIC -> com.tencent.ig.service.epic.EpicService.getDownloadInfo(displayInfo.gameId)
            com.tencent.ig.data.GameSource.GOG -> com.tencent.ig.service.gog.GOGService.getDownloadInfo(displayInfo.gameId.toString())
            com.tencent.ig.data.GameSource.CUSTOM_GAME -> null // Custom games don't support downloads yet
            com.tencent.ig.data.GameSource.AMAZON -> com.tencent.ig.service.amazon.AmazonService.getDownloadInfoByAppId(libraryItem.gameId)
        }
        ...
        com.tencent.ig.ui.screen.library.AppScreenContent(
