    ...
    override fun getGameDisplayInfo(
        ...
        LaunchedEffect(gameFolderPath) {
            gameFolderPath?.let { path ->
                ...
                val metadata = com.tencent.ig.utils.GameMetadataManager.read(folder)
                    ...
                    if (hasContainer) {
                        ...
                        if (!relExe.isNullOrEmpty()) {
                            ...
                            if (exeFile.exists()) {
                                ...
                                val extracted = com.tencent.ig.utils.ExeIconExtractor.tryExtractMainIcon(exeFile, outIco)
