package com.tencent.ig.service.gog

import android.content.Context
import com.tencent.ig.data.DownloadInfo
import com.tencent.ig.service.gog.api.DepotFile
import com.tencent.ig.service.gog.api.FileChunk
import com.tencent.ig.service.gog.api.GOGApiClient
import com.tencent.ig.service.gog.api.GOGManifestMeta
import com.tencent.ig.service.gog.api.GOGManifestParser
import com.tencent.ig.service.gog.api.V1DepotFile
...
class GOGDownloadManager @Inject constructor(
    ...
    suspend fun downloadGame(
        ...
        try {
            ...
            com.tencent.ig.PluviaApp.events.emitJava(
                com.tencent.ig.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, true),
            )
            ...
            com.tencent.ig.PluviaApp.events.emitJava(
                com.tencent.ig.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, false),
            )
    ...
    private suspend fun finalizeInstallSuccess(gameId: String, installPath: File, downloadInfo: DownloadInfo) {
        ...
        com.tencent.ig.PluviaApp.events.emitJava(
            com.tencent.ig.events.AndroidEvent.LibraryInstallStatusChanged(gameId.toIntOrNull() ?: 0),
        )
    }
    ...
    private suspend fun downloadGameGen1(
        ...
        installPath: File,
        downloadInfo: DownloadInfo,
        gameManifest: com.tencent.ig.service.gog.api.GOGManifestMeta,
        selectedBuild: com.tencent.ig.service.gog.api.GOGBuild,
        language: String,
        withDlcs: Boolean,
        supportDir: File?,
    ): Result<Unit> = withContext(Dispatchers.IO) {
