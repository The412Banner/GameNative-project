...
import com.tencent.ig.data.GOGCloudSavesLocation
import com.tencent.ig.data.GOGCloudSavesLocationTemplate
...
import com.tencent.ig.utils.FileUtils
...
class GOGManager @Inject constructor(
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                com.tencent.ig.PluviaApp.events.emitJava(
                    com.tencent.ig.events.AndroidEvent.LibraryInstallStatusChanged(libraryItem.gameId),
                )
    ...
    fun runScriptInterpreterIfNeeded(
        ...
        for (i in 0 until productsArray.length()) {
            ...
            try {
                PluviaApp.events.emit(com.tencent.ig.events.AndroidEvent.SetBootingSplashText("Running GOG script interpreter..."))
