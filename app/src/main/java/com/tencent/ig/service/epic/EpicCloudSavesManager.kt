package com.tencent.ig.service.epic

import android.content.Context
import com.tencent.ig.data.EpicGame
import com.tencent.ig.service.epic.manifest.EpicManifest
import com.tencent.ig.utils.Net
import java.io.File
...
object EpicCloudSavesManager {
    ...
    private suspend fun determineSyncAction(
        context: Context,
        accountId: String,
        game: com.tencent.ig.data.EpicGame,
    ...
    private fun packageSaveFiles(
        ...
        try {
            ...
            val chunks = mutableListOf<com.tencent.ig.service.epic.manifest.ChunkInfo>()
            val fileManifests = mutableListOf<com.tencent.ig.service.epic.manifest.FileManifest>()
            ...
            files.forEach { file ->
                try {
                    ...
                    val fileManifest = com.tencent.ig.service.epic.manifest.FileManifest()
                    ...
                    while (fileOffset < fileData.size) {
                        ...
                        val chunkPart = com.tencent.ig.service.epic.manifest.ChunkPart(
    ...
    private fun finalizeChunk(
    ...
    ): com.tencent.ig.service.epic.manifest.ChunkInfo {
        ...
        val chunkInfo = com.tencent.ig.service.epic.manifest.ChunkInfo()
        chunkInfo.guid = guid
    ...
    private fun createManifest(
        game: EpicGame,
        accountId: String,
        chunks: List<com.tencent.ig.service.epic.manifest.ChunkInfo>,
        fileManifests: List<com.tencent.ig.service.epic.manifest.FileManifest>,
    ): com.tencent.ig.service.epic.manifest.EpicManifest {
        val manifest = com.tencent.ig.service.epic.manifest.BinaryManifest()

        // Meta
        manifest.meta = com.tencent.ig.service.epic.manifest.ManifestMeta()
        ...
        // Custom fields
        manifest.customFields = com.tencent.ig.service.epic.manifest.CustomFields()
        manifest.customFields!!["CloudSaveFolder"] = game.saveFolder

        // Chunks
        manifest.chunkDataList = com.tencent.ig.service.epic.manifest.ChunkDataList()
        manifest.chunkDataList!!.elements.addAll(chunks)

        // Files
        manifest.fileManifestList = com.tencent.ig.service.epic.manifest.FileManifestList()
    ...
    private fun resolveSaveDirectory(context: Context, game: EpicGame, accountId: String): File? {
        ...
        val container = com.tencent.ig.utils.ContainerUtils.getOrCreateContainer(context, appId)
