...
import com.tencent.ig.service.NotificationHelper
...
class EpicService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_SYNC_LIBRARY = "com.tencent.ig.EPIC_SYNC_LIBRARY"
        private const val ACTION_MANUAL_SYNC = "com.tencent.ig.EPIC_MANUAL_SYNC"
        ...
        suspend fun deleteGame(context: Context, appId: Int): Result<Unit> {
            ...
            return try {
                ...
                com.tencent.ig.PluviaApp.events.emitJava(
                    com.tencent.ig.events.AndroidEvent.LibraryInstallStatusChanged(appId)
                )
