...
class EpicDownloadManager @Inject constructor(
    ...
    suspend fun downloadGame(
        ...
        try {
            ...
            com.tencent.ig.PluviaApp.events.emitJava(
                com.tencent.ig.events.AndroidEvent.DownloadStatusChanged(gameId, true),
            )
            ...
            com.tencent.ig.PluviaApp.events.emitJava(
                com.tencent.ig.events.AndroidEvent.LibraryInstallStatusChanged(gameId),
            )
            ...
            com.tencent.ig.PluviaApp.events.emitJava(
                com.tencent.ig.events.AndroidEvent.DownloadStatusChanged(gameId, false),
            )
        }
    }
    ...
    private suspend fun downloadChunkWithRetry(
        chunk: com.tencent.ig.service.epic.manifest.ChunkInfo,
        chunkCacheDir: File,
        chunkDir: String,
    ...
    private suspend fun assembleFile(
        fileManifest: com.tencent.ig.service.epic.manifest.FileManifest,
        chunkCacheDir: File,
        installDir: File,
    ): Result<File> = withContext(Dispatchers.IO) {
        try {
