...
object PrefManager {
    ...
    var librarySortOption: com.tencent.ig.ui.enums.SortOption
        get() {
            ...
            return if (keyValue.isNotEmpty()) {
                com.tencent.ig.ui.enums.SortOption.fromKey(keyValue)
            } else {
                val ordinal = getPref(LIBRARY_SORT_LEGACY, com.tencent.ig.ui.enums.SortOption.INSTALLED_FIRST.ordinal)
                @Suppress("DEPRECATION")
                com.tencent.ig.ui.enums.SortOption.fromOrdinal(ordinal)
            }
        }
        set(value) {
