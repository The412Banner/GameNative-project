...
import com.mihoyo.genshinimpact.data.EpicCredentials
...
import com.mihoyo.genshinimpact.data.EpicGameToken
...
import com.mihoyo.genshinimpact.service.NotificationHelper
...
class EpicService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_SYNC_LIBRARY = "com.mihoyo.genshinimpact.EPIC_SYNC_LIBRARY"
        private const val ACTION_MANUAL_SYNC = "com.mihoyo.genshinimpact.EPIC_MANUAL_SYNC"
        ...
        suspend fun deleteGame(context: Context, appId: Int): Result<Unit> {
            ...
            return try {
                ...
                com.mihoyo.genshinimpact.PluviaApp.events.emitJava(
                    com.mihoyo.genshinimpact.events.AndroidEvent.LibraryInstallStatusChanged(appId)
                )
