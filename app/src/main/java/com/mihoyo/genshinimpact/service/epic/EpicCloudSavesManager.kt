package com.mihoyo.genshinimpact.service.epic

import android.content.Context
import com.mihoyo.genshinimpact.data.EpicGame
import com.mihoyo.genshinimpact.service.epic.manifest.EpicManifest
import com.mihoyo.genshinimpact.utils.Net
import java.io.File
...
object EpicCloudSavesManager {
    ...
    private suspend fun determineSyncAction(
        context: Context,
        accountId: String,
        game: com.mihoyo.genshinimpact.data.EpicGame,
    ...
    private fun packageSaveFiles(
        ...
        try {
            ...
            val chunks = mutableListOf<com.mihoyo.genshinimpact.service.epic.manifest.ChunkInfo>()
            val fileManifests = mutableListOf<com.mihoyo.genshinimpact.service.epic.manifest.FileManifest>()
            ...
            files.forEach { file ->
                try {
                    ...
                    val fileManifest = com.mihoyo.genshinimpact.service.epic.manifest.FileManifest()
                    ...
                    while (fileOffset < fileData.size) {
                        ...
                        val chunkPart = com.mihoyo.genshinimpact.service.epic.manifest.ChunkPart(
    ...
    private fun finalizeChunk(
    ...
    ): com.mihoyo.genshinimpact.service.epic.manifest.ChunkInfo {
        ...
        val chunkInfo = com.mihoyo.genshinimpact.service.epic.manifest.ChunkInfo()
        chunkInfo.guid = guid
    ...
    private fun createManifest(
        game: EpicGame,
        accountId: String,
        chunks: List<com.mihoyo.genshinimpact.service.epic.manifest.ChunkInfo>,
        fileManifests: List<com.mihoyo.genshinimpact.service.epic.manifest.FileManifest>,
    ): com.mihoyo.genshinimpact.service.epic.manifest.EpicManifest {
        val manifest = com.mihoyo.genshinimpact.service.epic.manifest.BinaryManifest()

        // Meta
        manifest.meta = com.mihoyo.genshinimpact.service.epic.manifest.ManifestMeta()
        ...
        // Custom fields
        manifest.customFields = com.mihoyo.genshinimpact.service.epic.manifest.CustomFields()
        manifest.customFields!!["CloudSaveFolder"] = game.saveFolder

        // Chunks
        manifest.chunkDataList = com.mihoyo.genshinimpact.service.epic.manifest.ChunkDataList()
        manifest.chunkDataList!!.elements.addAll(chunks)

        // Files
        manifest.fileManifestList = com.mihoyo.genshinimpact.service.epic.manifest.FileManifestList()
    ...
    private fun resolveSaveDirectory(context: Context, game: EpicGame, accountId: String): File? {
        ...
        val container = com.mihoyo.genshinimpact.utils.ContainerUtils.getOrCreateContainer(context, appId)
