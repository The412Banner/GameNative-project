...
import com.mihoyo.genshinimpact.data.GOGCloudSavesLocation
import com.mihoyo.genshinimpact.data.GOGCloudSavesLocationTemplate
...
import com.mihoyo.genshinimpact.data.PostSyncInfo
import com.mihoyo.genshinimpact.data.SteamApp
import com.mihoyo.genshinimpact.db.dao.GOGGameDao
import com.mihoyo.genshinimpact.enums.AppType
import com.mihoyo.genshinimpact.enums.ControllerSupport
...
class GOGManager @Inject constructor(
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                com.mihoyo.genshinimpact.PluviaApp.events.emitJava(
                    com.mihoyo.genshinimpact.events.AndroidEvent.LibraryInstallStatusChanged(libraryItem.gameId),
                )
    ...
    fun runScriptInterpreterIfNeeded(
        ...
        for (i in 0 until productsArray.length()) {
            ...
            try {
                PluviaApp.events.emit(com.mihoyo.genshinimpact.events.AndroidEvent.SetBootingSplashText("Running GOG script interpreter..."))
