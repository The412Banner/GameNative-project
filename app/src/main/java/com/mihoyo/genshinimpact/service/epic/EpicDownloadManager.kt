...
class EpicDownloadManager @Inject constructor(
    ...
    suspend fun downloadGame(
        ...
        try {
            ...
            com.mihoyo.genshinimpact.PluviaApp.events.emitJava(
                com.mihoyo.genshinimpact.events.AndroidEvent.DownloadStatusChanged(gameId, true),
            )
            ...
            com.mihoyo.genshinimpact.PluviaApp.events.emitJava(
                com.mihoyo.genshinimpact.events.AndroidEvent.LibraryInstallStatusChanged(gameId),
            )
            ...
            com.mihoyo.genshinimpact.PluviaApp.events.emitJava(
                com.mihoyo.genshinimpact.events.AndroidEvent.DownloadStatusChanged(gameId, false),
            )
        }
    }
    ...
    private suspend fun downloadChunkWithRetry(
        chunk: com.mihoyo.genshinimpact.service.epic.manifest.ChunkInfo,
        chunkCacheDir: File,
        chunkDir: String,
    ...
    private suspend fun assembleFile(
        fileManifest: com.mihoyo.genshinimpact.service.epic.manifest.FileManifest,
        chunkCacheDir: File,
        installDir: File,
    ): Result<File> = withContext(Dispatchers.IO) {
        try {
