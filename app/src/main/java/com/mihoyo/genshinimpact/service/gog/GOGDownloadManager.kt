package com.mihoyo.genshinimpact.service.gog

import android.content.Context
import com.mihoyo.genshinimpact.data.DownloadInfo
import com.mihoyo.genshinimpact.service.gog.api.DepotFile
import com.mihoyo.genshinimpact.service.gog.api.FileChunk
import com.mihoyo.genshinimpact.service.gog.api.GOGApiClient
import com.mihoyo.genshinimpact.service.gog.api.GOGManifestMeta
import com.mihoyo.genshinimpact.service.gog.api.GOGManifestParser
import com.mihoyo.genshinimpact.service.gog.api.V1DepotFile
...
class GOGDownloadManager @Inject constructor(
    ...
    suspend fun downloadGame(
        ...
        try {
            ...
            com.mihoyo.genshinimpact.PluviaApp.events.emitJava(
                com.mihoyo.genshinimpact.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, true),
            )
            ...
            com.mihoyo.genshinimpact.PluviaApp.events.emitJava(
                com.mihoyo.genshinimpact.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, false),
            )
    ...
    private suspend fun finalizeInstallSuccess(gameId: String, installPath: File, downloadInfo: DownloadInfo) {
        ...
        com.mihoyo.genshinimpact.PluviaApp.events.emitJava(
            com.mihoyo.genshinimpact.events.AndroidEvent.LibraryInstallStatusChanged(gameId.toIntOrNull() ?: 0),
        )
    }
    ...
    private suspend fun downloadGameGen1(
        ...
        installPath: File,
        downloadInfo: DownloadInfo,
        gameManifest: com.mihoyo.genshinimpact.service.gog.api.GOGManifestMeta,
        selectedBuild: com.mihoyo.genshinimpact.service.gog.api.GOGBuild,
        language: String,
        withDlcs: Boolean,
        supportDir: File?,
    ): Result<Unit> = withContext(Dispatchers.IO) {
