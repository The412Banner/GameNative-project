...
object PrefManager {
    ...
    var librarySortOption: com.mihoyo.genshinimpact.ui.enums.SortOption
        get() {
            ...
            return if (keyValue.isNotEmpty()) {
                com.mihoyo.genshinimpact.ui.enums.SortOption.fromKey(keyValue)
            } else {
                val ordinal = getPref(LIBRARY_SORT_LEGACY, com.mihoyo.genshinimpact.ui.enums.SortOption.INSTALLED_FIRST.ordinal)
                @Suppress("DEPRECATION")
                com.mihoyo.genshinimpact.ui.enums.SortOption.fromOrdinal(ordinal)
            }
        }
        set(value) {
