package com.mihoyo.genshinimpact.ui.screen.library.appscreen
...
import com.mihoyo.genshinimpact.service.epic.EpicCloudSavesManager
import com.mihoyo.genshinimpact.service.epic.EpicConstants
import com.mihoyo.genshinimpact.service.epic.EpicService
import com.mihoyo.genshinimpact.ui.data.AppMenuOption
import com.mihoyo.genshinimpact.ui.data.GameDisplayInfo
...
import com.mihoyo.genshinimpact.utils.ContainerUtils.extractGameIdFromContainerId
...
import com.mihoyo.genshinimpact.ui.util.SnackbarManager
...
class EpicAppScreen : BaseAppScreen() {
    ...
    companion object {
        ...
        private val gameManagerDialogStates = mutableStateMapOf<Int, com.mihoyo.genshinimpact.ui.component.dialog.state.GameManagerDialogState>()

        fun showGameManagerDialog(gameId: Int, state: com.mihoyo.genshinimpact.ui.component.dialog.state.GameManagerDialogState) {
        ...
        fun getGameManagerDialogState(gameId: Int): com.mihoyo.genshinimpact.ui.component.dialog.state.GameManagerDialogState? {
    ...
    override fun getGameDisplayInfo(
        ...
        DisposableEffect(gameId) {
            val installListener: (com.mihoyo.genshinimpact.events.AndroidEvent.LibraryInstallStatusChanged) -> Unit = { event ->
            ...
            com.mihoyo.genshinimpact.PluviaApp.events.on<com.mihoyo.genshinimpact.events.AndroidEvent.LibraryInstallStatusChanged, Unit>(installListener)
            onDispose {
                com.mihoyo.genshinimpact.PluviaApp.events.off<com.mihoyo.genshinimpact.events.AndroidEvent.LibraryInstallStatusChanged, Unit>(installListener)
            }
        }
    ...
    override fun onDownloadInstallClick(context: Context, libraryItem: LibraryItem, onClickPlay: (Boolean) -> Unit) {
        ...
        if (isDownloading) {
            ...
            showInstallDialog(
                libraryItem.appId,
                com.mihoyo.genshinimpact.ui.component.dialog.state.MessageDialogState(
                    visible = true,
                    type = com.mihoyo.genshinimpact.ui.enums.DialogType.CANCEL_APP_DOWNLOAD,
            ...
            showGameManagerDialog(
                gameId,
                com.mihoyo.genshinimpact.ui.component.dialog.state.GameManagerDialogState(visible = true)
            )
        }
    }
    ...
    override fun loadContainerData(context: Context, libraryItem: LibraryItem): ContainerData {
        ...
        val container = com.mihoyo.genshinimpact.utils.ContainerUtils.getOrCreateContainer(context, libraryItem.appId)
        val containerData = com.mihoyo.genshinimpact.utils.ContainerUtils.toContainerData(container)
    ...
    override fun saveContainerConfig(context: Context, libraryItem: LibraryItem, config: ContainerData) {
        ...
        com.mihoyo.genshinimpact.utils.ContainerUtils.applyToContainer(context, libraryItem.appId, config)
    ...
    override fun observeGameState(
        ...
        val downloadStatusListener: (com.mihoyo.genshinimpact.events.AndroidEvent.DownloadStatusChanged) -> Unit = { event ->
        ...
        com.mihoyo.genshinimpact.PluviaApp.events.on<com.mihoyo.genshinimpact.events.AndroidEvent.DownloadStatusChanged, Unit>(downloadStatusListener)
        disposables +=
            { com.mihoyo.genshinimpact.PluviaApp.events.off<com.mihoyo.genshinimpact.events.AndroidEvent.DownloadStatusChanged, Unit>(downloadStatusListener) }
    ...
    override fun AdditionalDialogs(
        ...
        var installDialogState by remember(appId) {
            mutableStateOf(BaseAppScreen.getInstallDialogState(appId) ?: com.mihoyo.genshinimpact.ui.component.dialog.state.MessageDialogState(false))
        }
        LaunchedEffect(appId) {
            snapshotFlow { BaseAppScreen.getInstallDialogState(appId) }
                .collect { state ->
                    installDialogState = state ?: com.mihoyo.genshinimpact.ui.component.dialog.state.MessageDialogState(false)
                }
        }

        // Game manager dialog state
        var gameManagerDialogState by remember(gameId) {
            mutableStateOf(getGameManagerDialogState(gameId) ?: com.mihoyo.genshinimpact.ui.component.dialog.state.GameManagerDialogState(false))
        }
        LaunchedEffect(gameId) {
            snapshotFlow { getGameManagerDialogState(gameId) }
                .collect { state ->
                    gameManagerDialogState = state ?: com.mihoyo.genshinimpact.ui.component.dialog.state.GameManagerDialogState(false)
                }
        }
        ...
        if (installDialogState.visible) {
            ...
            val onConfirmClick: (() -> Unit)? = when (installDialogState.type) {
                com.mihoyo.genshinimpact.ui.enums.DialogType.INSTALL_APP -> {
                    {
                        BaseAppScreen.hideInstallDialog(appId)
                        performDownload(scope, context, libraryItem, listOf(libraryItem.gameId)) {}
                    }
                }
                com.mihoyo.genshinimpact.ui.enums.DialogType.CANCEL_APP_DOWNLOAD -> {
                    {
                        ...
                        scope.launch {
                            ...
                            withContext(Dispatchers.Main) {
                                BaseAppScreen.hideInstallDialog(appId)
                                com.mihoyo.genshinimpact.PluviaApp.events.emit(com.mihoyo.genshinimpact.events.AndroidEvent.DownloadStatusChanged(gameId, false))
                                com.mihoyo.genshinimpact.PluviaApp.events.emit(com.mihoyo.genshinimpact.events.AndroidEvent.LibraryInstallStatusChanged(gameId))
                            }
                        }
                    }
                }
            ...
            com.mihoyo.genshinimpact.ui.component.dialog.MessageDialog(
        ...
        if (gameManagerDialogState.visible) {
            com.mihoyo.genshinimpact.ui.component.dialog.EpicGameManagerDialog(
                visible = true,
