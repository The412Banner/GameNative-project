...
import com.mihoyo.genshinimpact.utils.GameMetadataManager
import com.mihoyo.genshinimpact.utils.SteamGridDB
import com.mihoyo.genshinimpact.utils.createPinnedShortcut
...
abstract class BaseAppScreen {
    ...
    companion object {
        private val installDialogStates = mutableStateMapOf<String, com.mihoyo.genshinimpact.ui.component.dialog.state.MessageDialogState>()

        fun showInstallDialog(appId: String, state: com.mihoyo.genshinimpact.ui.component.dialog.state.MessageDialogState) {
        ...
        fun getInstallDialogState(appId: String): com.mihoyo.genshinimpact.ui.component.dialog.state.MessageDialogState? {
    ...
    fun Content(
        ...
        val downloadInfo = when (libraryItem.gameSource) {
            com.mihoyo.genshinimpact.data.GameSource.STEAM -> com.mihoyo.genshinimpact.service.SteamService.getAppDownloadInfo(displayInfo.gameId)
            com.mihoyo.genshinimpact.data.GameSource.EPIC -> com.mihoyo.genshinimpact.service.epic.EpicService.getDownloadInfo(displayInfo.gameId)
            com.mihoyo.genshinimpact.data.GameSource.GOG -> com.mihoyo.genshinimpact.service.gog.GOGService.getDownloadInfo(displayInfo.gameId.toString())
            com.mihoyo.genshinimpact.data.GameSource.CUSTOM_GAME -> null // Custom games don't support downloads yet
            com.mihoyo.genshinimpact.data.GameSource.AMAZON -> com.mihoyo.genshinimpact.service.amazon.AmazonService.getDownloadInfoByAppId(libraryItem.gameId)
        }
        ...
        com.mihoyo.genshinimpact.ui.screen.library.AppScreenContent(
