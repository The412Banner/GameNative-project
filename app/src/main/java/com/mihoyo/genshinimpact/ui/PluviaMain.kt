package com.mihoyo.genshinimpact.ui
...
import com.mihoyo.genshinimpact.Constants
import com.mihoyo.genshinimpact.MainActivity
...
import com.mihoyo.genshinimpact.enums.AppTheme
import com.mihoyo.genshinimpact.enums.LoginResult
import com.mihoyo.genshinimpact.enums.PathType
import com.mihoyo.genshinimpact.enums.SaveLocation
import com.mihoyo.genshinimpact.enums.SyncResult
...
import com.mihoyo.genshinimpact.ui.component.ConnectionStatusBanner
import com.mihoyo.genshinimpact.service.epic.EpicService
import com.mihoyo.genshinimpact.service.gog.GOGService
import com.mihoyo.genshinimpact.ui.component.dialog.ContainerConfigDialog
import com.mihoyo.genshinimpact.ui.component.dialog.GameFeedbackDialog
import com.mihoyo.genshinimpact.ui.component.dialog.LoadingDialog
import com.mihoyo.genshinimpact.ui.component.dialog.MessageDialog
import com.mihoyo.genshinimpact.ui.component.dialog.state.GameFeedbackDialogState
import com.mihoyo.genshinimpact.ui.component.dialog.state.MessageDialogState
import com.mihoyo.genshinimpact.ui.components.BootingSplash
import com.mihoyo.genshinimpact.ui.enums.AppOptionMenuType
import com.mihoyo.genshinimpact.ui.enums.ConnectionState
import com.mihoyo.genshinimpact.ui.enums.DialogType
import com.mihoyo.genshinimpact.ui.enums.Orientation
import com.mihoyo.genshinimpact.ui.model.MainViewModel
import com.mihoyo.genshinimpact.ui.screen.HomeScreen
import com.mihoyo.genshinimpact.ui.screen.PluviaScreen
import com.mihoyo.genshinimpact.ui.screen.login.UserLoginScreen
import com.mihoyo.genshinimpact.ui.screen.settings.SettingsScreen
import com.mihoyo.genshinimpact.ui.screen.xserver.XServerScreen
import com.mihoyo.genshinimpact.ui.theme.PluviaTheme
import com.mihoyo.genshinimpact.ui.util.SnackbarManager
import com.mihoyo.genshinimpact.utils.BestConfigService
import com.mihoyo.genshinimpact.utils.ContainerUtils
import com.mihoyo.genshinimpact.utils.PlatformAuthUtils
import com.mihoyo.genshinimpact.utils.CustomGameScanner
import com.mihoyo.genshinimpact.utils.ManifestInstaller
import com.mihoyo.genshinimpact.utils.GameFeedbackUtils
import com.mihoyo.genshinimpact.utils.IntentLaunchManager
import com.mihoyo.genshinimpact.utils.UpdateChecker
import com.mihoyo.genshinimpact.utils.UpdateInfo
import com.mihoyo.genshinimpact.utils.UpdateInstaller
import com.mihoyo.genshinimpact.utils.LaunchDependencies
...
fun PluviaMain(
    ...
    LaunchedEffect(Unit) {
        lifecycleOwner.lifecycle.repeatOnLifecycle(Lifecycle.State.STARTED) {
            ...
            if (com.mihoyo.genshinimpact.service.gog.GOGService.hasStoredCredentials(context) &&
                !com.mihoyo.genshinimpact.service.gog.GOGService.isRunning
            ) {
                Timber.tag("GOG").d("[PluviaMain]: Starting GOGService for logged-in user")
                com.mihoyo.genshinimpact.service.gog.GOGService.start(context)
            } else {
                Timber.tag("GOG").d("GOG SERVICE Not going to start: ${com.mihoyo.genshinimpact.service.gog.GOGService.isRunning}")
            }

            // Start EpicService if user has Epic credentials
            if (com.mihoyo.genshinimpact.service.epic.EpicService.hasStoredCredentials(context) &&
                !com.mihoyo.genshinimpact.service.epic.EpicService.isRunning
            ) {
                Timber.d("[PluviaMain]: Starting EpicService for logged-in user")
                com.mihoyo.genshinimpact.service.epic.EpicService.start(context)
            }
...
fun preLaunchApp(
    ...
    CoroutineScope(Dispatchers.IO).launch {
        ...
        if (isGOGGame) {
            ...
            val syncSuccess = com.mihoyo.genshinimpact.service.gog.GOGService.syncCloudSaves(
                context = context,
                appId = appId,
            )
        ...
        if (isEpicGame) {
            ...
            val syncSuccess = com.mihoyo.genshinimpact.service.epic.EpicCloudSavesManager.syncCloudSaves(
                context = context,
                appId = gameId,
            )
