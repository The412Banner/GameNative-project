...
import com.mihoyo.genshinimpact.service.gog.GOGConstants
...
import com.mihoyo.genshinimpact.utils.ContainerUtils.getContainer
    ...
    private fun showGOGInstallConfirmationDialog(context: Context, libraryItem: LibraryItem) {
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            try {
                ...
                // Calculate sizes
                val downloadSize = com.mihoyo.genshinimpact.utils.StorageUtils.formatBinarySize(game?.downloadSize ?: 0L)
                val availableSpace = com.mihoyo.genshinimpact.utils.StorageUtils.formatBinarySize(
                    com.mihoyo.genshinimpact.utils.StorageUtils.getAvailableSpace(com.mihoyo.genshinimpact.service.gog.GOGConstants.defaultGOGGamesPath)
                )
                ...
                val state = com.mihoyo.genshinimpact.ui.component.dialog.state.MessageDialogState(
                    visible = true,
                    type = com.mihoyo.genshinimpact.ui.enums.DialogType.INSTALL_APP,
