    ...
    override fun getGameDisplayInfo(
        ...
        LaunchedEffect(gameFolderPath) {
            gameFolderPath?.let { path ->
                ...
                val metadata = com.mihoyo.genshinimpact.utils.GameMetadataManager.read(folder)
                    ...
                    if (hasContainer) {
                        ...
                        if (!relExe.isNullOrEmpty()) {
                            ...
                            if (exeFile.exists()) {
                                ...
                                val extracted = com.mihoyo.genshinimpact.utils.ExeIconExtractor.tryExtractMainIcon(exeFile, outIco)
