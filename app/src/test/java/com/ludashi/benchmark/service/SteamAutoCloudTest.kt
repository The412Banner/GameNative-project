...
class SteamAutoCloudTest {
    ...
    fun setUp() {
        ...
        runBlocking {
            db.appChangeNumbersDao().insert(com.ludashi.benchmark.data.ChangeNumbers(steamAppId, 0))
...
//    @Test
    ...
    fun testUploadOnSubsequentBoots() = runBlocking {
        ...
        runBlocking {
            db.appChangeNumbersDao().deleteByAppId(steamAppId)
            db.appFileChangeListsDao().deleteByAppId(steamAppId)
            db.appChangeNumbersDao().insert(com.ludashi.benchmark.data.ChangeNumbers(steamAppId, matchingChangeNumber.toLong()))
            ...
            val oldUserFile = com.ludashi.benchmark.data.UserFileInfo(
                root = PathType.WinMyDocuments,
                path = "My Games/TestGame/Steam/76561198025127569",
    ...
    fun testNoPrefixUpload() = runBlocking {
        ...
        runBlocking {
            ...
            val oldFileContent = "old file content".toByteArray()
            val oldFileSha = CryptoHelper.shaHash(oldFileContent)
            val oldUserFile1 = com.ludashi.benchmark.data.UserFileInfo(
            ...
            val oldUserFile2 = com.ludashi.benchmark.data.UserFileInfo(
                root = PathType.GameInstall,
                path = ".",
                filename = "save2.sav",
                timestamp = System.currentTimeMillis() - 10000,
